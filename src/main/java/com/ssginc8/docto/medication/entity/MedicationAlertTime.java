 ...
 * 복약 시간 Entity
 *
 * - 복약 정보(MedicationInformation)에 연관된 알림 시간
...
public class MedicationAlertTime {
	...
	public static MedicationAlertTime create(MedicationInformation medication, LocalDateTime timeToTake) {
	...
	public void updateTimeToTake(LocalDateTime newTime) {
